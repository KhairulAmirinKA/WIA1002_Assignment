...
import ga_wia1002.StaytheHellAwayfromMeClass.Graph;
import java.util.*;
...
public class StaytheHellAwayfromMe {
    ...
    private static int calculateTotalDistance(Graph graph, List<String> path) {
        ...
        for (int i = 0; i < path.size() - 1; i++) {
            ...
            for (StaytheHellAwayfromMeClass.Location neighbor : graph.adjacencyList.get(sourceIndex)) {
...
//        StaytheHellAwayfromMe Q6extra = new StaytheHellAwayfromMe();
